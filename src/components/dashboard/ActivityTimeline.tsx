...
export function ActivityTimeline() {
  return (
    <GlassCard className="h-[400px] flex flex-col" delay={600}>
      ...
      <div className="flex-1 relative mt-2">
        ...
        <div className="absolute top-0 bottom-0 left-[62%] w-px bg-primary z-20 flex flex-col items-center">
          <div className="bg-primary text-primary-foreground text-[10px] font-bold px-2 py-0.5 rounded-full -mt-3 shadow-md">
            12:00
          </div>
          ...
          <div className="relative left-[40%] w-[40%] bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm p-3 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 border border-border mt-6 group cursor-pointer">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Figma file</p>
              </div>
              <div className="flex -space-x-2">
